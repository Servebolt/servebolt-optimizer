...
use Servebolt\Optimizer\CronControl\Cronjobs\ActionScheduler;
...
class CronControlTest extends ServeboltWPUnitTestCase
{
    ...
    public function testThatWeCanGenerateActionSchedulerEventRunCommand()
    {
        ...
        $interval = '* * * * *';
        $this->assertEquals('action-scheduler-single-site', ActionScheduler::$commandName);
        $this->assertEquals('1', ActionScheduler::$commandRevision);
        $this->assertEquals($command, ActionScheduler::generateCommand());
        $this->assertEquals($comment, ActionScheduler::generateComment());
        $this->assertEquals($interval, ActionScheduler::getInterval());
        $this->assertEquals($interval . ' ' . $command, ActionScheduler::generateCronjob(false));
        $this->assertEquals($interval . ' ' . $command . ' ' . $comment, ActionScheduler::generateCronjob());
    }
}
