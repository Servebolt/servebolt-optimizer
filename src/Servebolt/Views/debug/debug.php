...
<div class="wrap sb-content" id="sb-configuration">
	...
	<p>Feature is active? - <?php echo CachePurge::cachePurgeIsActive() ? sb__('Yes') : sb__('No'); ?></p>
	<p>Feature is configured? - <?php echo CachePurge::featureIsConfigured() ? sb__('Yes') : sb__('No'); ?></p>
	<p>Feature is available? - <?php echo CachePurge::featureIsAvailable() ? sb__('Yes') : sb__('No'); ?></p>
	<p>Automatic cache purge on content update? - <?php echo CachePurge::automaticCachePurgeOnContentUpdateIsActive() ? sb__('Yes') : sb__('No'); ?></p>
