...
<tr class="sb-toggle-active-cron-item<?php if ( ! sb_cf_cache()->cron_purge_is_active() ) echo ' cf-hidden-cron'; ?>">
    <td colspan="2" style="padding-top:0;padding-left:0;">
        ...
        <div class="tablenav top">
            ...
            <div class="alignleft actions bulkactions">
                <button type="button" style="float:left;" class="button action flush-purge-items-queue"<?php if ( count($items_to_purge) === 0 ) echo ' disabled'; ?>><?php _e('Flush queue', 'servebolt-wp'); ?></button>
            </div>
            <div class="alignleft actions bulkactions">
