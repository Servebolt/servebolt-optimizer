...
<?php $env = Servebolt\Optimizer\EnvFile\Reader::getInstance(); ?>
<?php $configurationOk = !is_null($env->id) && !is_null($env->api_key); ?>
...
<tbody class="sb-config-field-general sb-config-field-acd <?php if ( ! $settings['cache_purge_switch'] || $settings['cache_purge_driver'] !== 'acd' ) echo 'sb-config-field-hidden'; ?>">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="sb-pwd">
                <input type="password" id="sb_api_key" value="<?php echo esc_attr($env->api_key); ?>" class="regular-text validate-field" readonly>
