    ...
    <td>
        <fieldset>
            ...
            <label for="wp_unix_cron_active">
                <input name="<?php echo getOptionName('wp_unix_cron_active'); ?>" type="checkbox" id="wp_unix_cron_active" value="1" <?php echo $envFileIsRead ? '': 'disabled'; ?> <?php checked( ( $settings['wp_unix_cron_active'] || ( defined('DISABLE_WP_CRON') && DISABLE_WP_CRON ) ) ); ?>>
