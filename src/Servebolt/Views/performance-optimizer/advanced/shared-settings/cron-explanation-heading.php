...
<tr>
    ...
    <td>
        ...
        <p style="color: red;"><?php printf(__('To fix this then go to your %ssite settings%s, click "Settings" and make sure that the setting "Environment file in home folder" is <strong>not</strong> set to "None". Remember to click "Save settings" to ensure that the file is written to disk regardless of the previous state of the setting.', 'servebolt-wp'), '<a href="' . getServeboltAdminUrl() . '" target="_blank">', '</a>'); ?></p>
        <?php endif; ?>
    </td>
</tr>
