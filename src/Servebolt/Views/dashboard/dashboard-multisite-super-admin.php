...
<?php if (isHostedAtServebolt()) : ?>
    <a href="<?php echo network_admin_url('admin.php?page=servebolt-html-cache'); ?>" class="sb-button yellow">
...
<a href="<?php echo network_admin_url('admin.php?page=servebolt-general-settings'); ?>" class="sb-button yellow">
