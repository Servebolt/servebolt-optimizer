 ...
 *
 * Borrowed from package wp-cli/wp-config-transformer. Place manually into project due to complexity surrounding automatic class/namespace-prefixing and possible conflicts with other plugins etc.
 */
