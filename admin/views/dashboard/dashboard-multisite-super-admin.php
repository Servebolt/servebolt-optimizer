<a href="<?php echo network_admin_url('admin.php?page=servebolt-performance-tools'); ?>" class="sb-button yellow">
    <?php sb_e('Performance Optimizer'); ?>
</a>

<a href="<?php echo network_admin_url('admin.php?page=servebolt-cf-cache-control'); ?>" class="sb-button yellow">
...
<?php if ( host_is_servebolt() ) : ?>
    <a href="<?php echo network_admin_url('admin.php?page=servebolt-nginx-cache'); ?>" class="sb-button yellow">
...
<a href="<?php echo network_admin_url('admin.php?page=servebolt-general-settings'); ?>" class="sb-button yellow"><?php sb_e('General settings'); ?></a>
